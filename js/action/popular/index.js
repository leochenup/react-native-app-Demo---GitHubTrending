...
export const onLoadPopularData = (storeName, url, pageSize) => {
    return async dispatch => {
        ...
        try {
            ...
            handleData(Types.POPULAR_DROPDOWN_REFRESH_SUCCESS, dispatch, storeName, data, pageSize)
        } catch (error) {
 ...
 * @param {*} callback 
 */
export const onLoadMorePopularData = (storeName, pageIndex, pageSize, dataArray = [], callback) => {
    return (dispatch) => {
        setTimeout(() => { //模拟网络请求
